...
import {FileCodeIcon,PollHIcon, ExclamationTriangleIcon, FileContractIcon,  InProgressIcon,RedoIcon ,InfrastructureIcon, UserCogIcon, VirtualMachineIcon} from '@patternfly/react-icons';
...
{c.Name}
    ...
    {c.Name === "Monitoring"
        ...
        ? <FileCodeIcon color='#ee0000' size='md'/>:  <ExclamationTriangleIcon color='#ee0000' size='md'/> 
      }
